  ...
  <head>
    <title>
      /scala-tool-support/trunk/src/vim/ftdetect/scala.vim – Scala
        ...
        <link rel="alternate" href="/trac/scala/export/18639/scala-tool-support/trunk/src/vim/ftdetect/scala.vim" type="text/plain" title="Original Format" />
  ...
  <body>
    ...
    <br style="clear: both" />
      ...
      <table id="info" summary="Revision info">
        <tr>
          <th scope="col">
            Revision <a href="/trac/scala/changeset/15234">15234</a>, <span title="65 bytes">65 bytes</span>
...
now it should work<br />
    ...
    <table class="code"><thead><tr><th class="lineno" title="Line numbers">Line</th><th class="content"> </th></tr></thead><tbody><tr><th id="L1"><a href="#L1">1</a></th><td>"        $URL$</td></tr><tr><th id="L2"><a href="#L2">2</a></th><td></td></tr><tr><th id="L3"><a href="#L3">3</a></th><td>au BufRead,BufNewFile *.scala set filetype=scala</td></tr></tbody></table>
      </div>
      <div id="help">
    ...
    <div id="altlinks">
      ...
      <ul>
        <li class="last first">
          <a rel="nofollow" href="/trac/scala/export/18639/scala-tool-support/trunk/src/vim/ftdetect/scala.vim">Original Format</a>
        </li>
      </ul>
    </div>
    </div>
